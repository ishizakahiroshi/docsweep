...
(function () {
  ...
  const TABLES = {
    ja: {
      ...
      // ===== UX W4（C4）=====
      dnd_effect_today: "期日を今日にします",
      dnd_effect_start: "期日を今日にして [実行中] にします",
      dnd_effect_future: "期日を指定して先送りします",
      dnd_effect_rejected: "この列へは落とせません",
      show_snoozed: "非表示分も出す",
      pin_action: "固定",
      unpin_action: "固定解除",
      pin_badge: "📌 固定",
      snooze_action: "今日は見ない",
      unsnooze_action: "非表示を解除",
      snooze_badge: "💤 今日は非表示",
      tour_next: "次へ",
      tour_done: "はじめる",
      tour_1_title: "やり忘れ列から見る",
      tour_1_body: "左の列が期限を過ぎたもの。ここが 0 なら今日はきれいです。",
      tour_2_title: "変更▾ で状態を進める",
      tour_2_body: "カード下段の「変更▾」でラベルを進めます。数字キー 1〜5 でも同じことができます。",
      tour_3_title: "完了は archive へ移る",
      tour_3_body: "[完了] / [廃止] にしたものは sweep で archive へ移ります。取り消しは Undo。",
      tour_4_title: "設定はここ",
      tour_4_body: "右上の歯車でスキャン対象や注入を設定します。密度と高コントラストもその隣です。",
      confirm_phrase_label: "確認のため {0} と入力してください",
      confirm_phrase_count: "{0} 件をまとめて変更します。取り消しは Undo でできます",
    },
    en: {
      loading: "Loading…",
      ...
      // ===== UX W4 (C4) =====
      dnd_effect_today: "Sets the due date to today",
      dnd_effect_start: "Sets due to today and marks it In Progress",
      dnd_effect_future: "Asks for a date and postpones it",
      dnd_effect_rejected: "Cannot drop into this column",
      show_snoozed: "Show snoozed",
      pin_action: "Pin",
      unpin_action: "Unpin",
      pin_badge: "📌 Pinned",
      snooze_action: "Snooze today",
      unsnooze_action: "Unsnooze",
      snooze_badge: "💤 Snoozed",
      tour_next: "Next",
      tour_done: "Start",
      tour_1_title: "Start with the overdue column",
      tour_1_body: "The left column is past its due date. An empty column means today is clear.",
      tour_2_title: "Move state with Change",
      tour_2_body: "Use the Change button on a card to advance its label. Number keys 1-5 do the same.",
      tour_3_title: "Finished work moves to archive",
      tour_3_body: "[完了] / [廃止] files are moved to archive by sweep. Undo restores them.",
      tour_4_title: "Settings live here",
      tour_4_body: "The gear icon sets scan roots and injection. Density and high contrast sit next to it.",
      confirm_phrase_label: "Type {0} to confirm",
      confirm_phrase_count: "This changes {0} files at once. You can Undo afterwards",
    },
  };
